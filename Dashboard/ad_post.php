                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Date:</label><input type="date" class="form-control" placeholder="From">
                                                </div>

                                                
                                                <div class="form-group">
                                                    <label>Pickup:</label><input type="text" class="form-control" placeholder="Enter Pickup Location">
                                                </div>

                                                <div class="form-group">
                                                    <label>Seats:</label><input type="number" class="form-control" placeholder="Enter total Seats">
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Description</label>
                                                    <textarea class="form-control" rows="3" placeholder="Enter Some Details for the help of your clients (Optional)"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                          
                                                <div class="form-group">
                                                    <label>Time:</label><input type="time" class="form-control" placeholder="From">
                                                </div>
                                                <div class="form-group">
                                                    <label>Dropoff:</label><input type="text" class="form-control" placeholder="Enter Dropoff Location">
                                                </div>
                                                <div class="form-group">
                                                    <label>Price per seat:</label><input type="text" class="form-control" placeholder="Enter Price for per site">
                                                </div>
